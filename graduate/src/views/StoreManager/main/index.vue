  ...
  <d2-container>
    <manager-tab>
      <template slot="content">
        <el-input v-model="key" placeholder="请输入相关仓库关键字" size="small"></el-input>
    ...
    <manager-table
      ...
      <template slot="template">
        <vxe-table-column field="name" title="仓库名称" min-width="200"></vxe-table-column>
...
import { GetTableData, SaveCustomer, UpdateCustomer, DeleteCustomer } from '@/api/modules/storeManager'
