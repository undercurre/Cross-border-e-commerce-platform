  ...
  methods: {
    ...
    handleClick (tab, event) {
      ...
      if (page) {
        ...
        console.log(menuHeader.filter(item => item.children.path === page.fullPath))
        this.$store.commit('d2admin/menu/asideSet', menuHeader.filter(item => item.path === page.fullPath))
      }
    },
    /**
